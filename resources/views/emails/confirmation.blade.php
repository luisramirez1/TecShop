                                ...
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
    									...
    									<h2 id="acerca">¡Gracias por registrarte!</h2>
    									 ...
    									 <p>Estamos bastante seguros de que este es el comienzo de algo muy especial, así que queríamos tomar un momento para darle personalmente la bienvenida a TecShop. Nos gusta pensar en TecShop como la mejor manera de comprar productos tecnologicos de la mas alta calidad, es genial tenerle a bordo!</p> <br>
                            ...
                            <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            &copy; {{ date('Y') }}
                                            <a style="{{ $style['anchor'] }}" href="{{ url('/') }}" target="_blank">TecShop</a>.
                                            All rights reserved.
                                        </p>
                                    </td>
                                </tr>
